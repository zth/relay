...
and input_InputA_nullable = {
  ...
  timestamp?: Null.t<Timestamp.t>,
  timestamps?: Null.t<array<Null.t<Timestamp.t>>>,
  unmapped?: Null.t<RescriptRelay.any>,
}
...
and input_InputB_nullable = {
  time?: Null.t<SomeModule.Datetime.t>,
...
and input_LocationWithoutDirective_nullable = {
  byAddress?: Null.t<input_ByAddress_nullable>,
  byLoc?: Null.t<input_ByLoc_nullable>,
  byId?: Null.t<string>,
}
