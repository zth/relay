...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "TestReQueryWithRequired_BubbleToTop_Query",
    "selections": [
      {
        "kind": "RequiredField",
        "field": {
  ...
  "params": {
    "cacheID": "1bbd76c21f3b1895745f45e0b1a4d0ed",
    "id": null,
    "metadata": {},
    "name": "TestReQueryWithRequired_BubbleToTop_Query",
    "operationKind": "query",
    "text": "query TestReQueryWithRequired_BubbleToTop_Query {\n  loggedInUser {\n    avatarUrl\n    id\n  }\n}\n"
  }
};
})() |json}]
