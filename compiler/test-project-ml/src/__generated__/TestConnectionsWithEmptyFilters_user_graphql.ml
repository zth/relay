...
[@@mel.inline]
[%%private
  external internal_makeConnectionId: Melange_relay.dataId -> (_ [@mel.as "TestConnectionsWithEmptyFilters_user_friendsConnection"]) -> 'arguments -> Melange_relay.dataId = "getConnectionID"
