...
module Internal = {
  ...
  %%private(
  @live
  let wrapResponseConverter: JSON.t = %raw(json`{"roots":{"__root":[{"list":1,"path":["members","edges"]},{"path":["members","edges","node","value"],"union":"0"}]},"version":2}`)
  @live
  let wrapResponseCallbacks = {
    "0": wrap_response_members_edges_node_value,
  }
  @live
  ...
  let responseCallbacks = {
    "0": unwrap_response_members_edges_node_value,
  }
  @live
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "TestCatchAndFriends3Query",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "02be2c626e610e41de0943e277c4f2d4",
    "id": null,
    "metadata": {},
    "name": "TestCatchAndFriends3Query",
    "operationKind": "query",
    "text": "query TestCatchAndFriends3Query {\n  members(groupId: \"123\") {\n    edges {\n      node {\n        __typename\n        ... on User {\n          id\n        }\n        ... on Node {\n          __isNode: __typename\n          __typename\n          id\n        }\n        ... on person {\n          id\n        }\n      }\n    }\n  }\n}\n"
  }
};
})() `)
