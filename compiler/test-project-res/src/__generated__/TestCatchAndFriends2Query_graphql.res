...
module Internal = {
  ...
  %%private(
  @live
  let wrapResponseConverter: JSON.t = %raw(json`{"roots":{"__root":[{"path":["member","value"],"union":"1"},{"path":["member","value","User","memberOfSingular","value"],"union":"2"},{"path":["member","value","User","memberOfSingular","value","User","createdAt"],"scalar":"0"}]},"version":2}`)
  @live
  let wrapResponseCallbacks = {
    "0": SomeModule.Datetime.serialize,
    "1": wrap_response_member_value,
    "2": wrap_response_member_value_User_memberOfSingular_value,
  }
  @live
  ...
  let responseCallbacks = {
    ...
    "1": unwrap_response_member_value,
    "2": unwrap_response_member_value_User_memberOfSingular_value,
  }
  @live
