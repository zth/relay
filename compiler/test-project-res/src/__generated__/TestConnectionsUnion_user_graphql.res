...
@live
let unwrap_fragment_member: fragment_member => fragment_member = RescriptRelay__Internal.unwrapUnion
@live
let wrap_fragment_member: fragment_member => fragment_member = RescriptRelay__Internal.wrapUnion
module Internal = {
  @live
  type fragmentRaw
  @live
