...
@live
let unwrap_response_member: response_member => response_member = RescriptRelay__Internal.unwrapUnion
@live
let wrap_response_member: response_member => response_member = RescriptRelay__Internal.wrapUnion
module Internal = {
  @live
