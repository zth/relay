...
@live
let unwrap_fragment_members_edges_node: fragment_members_edges_node => fragment_members_edges_node = RescriptRelay__Internal.unwrapUnion
@live
let wrap_fragment_members_edges_node: fragment_members_edges_node => fragment_members_edges_node = RescriptRelay__Internal.wrapUnion
module Internal = {
  @live
  type fragmentRaw
  @live
