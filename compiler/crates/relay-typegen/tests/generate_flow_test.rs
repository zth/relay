...
fn actor_change() {
    ...
    test_fixture(
        transform_fixture,
        "actor-change.graphql",
        "generate_flow/fixtures/actor-change.expected",
        input,
        expected,
    );
}
...
fn actor_change_with_query() {
    ...
    test_fixture(
        transform_fixture,
        "actor-change-with-query.graphql",
        "generate_flow/fixtures/actor-change-with-query.expected",
        input,
        expected,
    );
}
...
fn aliased_fragment_raw_response_type() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/aliased-fragment-raw-response-type.expected");
    test_fixture(
        transform_fixture,
        "aliased-fragment-raw-response-type.graphql",
        "generate_flow/fixtures/aliased-fragment-raw-response-type.expected",
        input,
        expected,
    );
}
...
fn aliased_fragment_spread() {
    ...
    test_fixture(
        transform_fixture,
        "aliased-fragment-spread.graphql",
        "generate_flow/fixtures/aliased-fragment-spread.expected",
        input,
        expected,
    );
}
...
fn aliased_fragment_spread_in_abstract_selection() {
    let input = include_str!(
        "generate_flow/fixtures/aliased-fragment-spread-in-abstract-selection.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/aliased-fragment-spread-in-abstract-selection.expected"
    );
    test_fixture(
        transform_fixture,
        "aliased-fragment-spread-in-abstract-selection.graphql",
        "generate_flow/fixtures/aliased-fragment-spread-in-abstract-selection.expected",
        input,
        expected,
    );
...
fn aliased_inline_fragment_spread() {
    ...
    test_fixture(
        transform_fixture,
        "aliased-inline-fragment-spread.graphql",
        "generate_flow/fixtures/aliased-inline-fragment-spread.expected",
        input,
        expected,
    );
}
...
fn custom_scalar_type_import() {
    ...
    test_fixture(
        transform_fixture,
        "custom-scalar-type-import.graphql",
        "generate_flow/fixtures/custom-scalar-type-import.expected",
        input,
        expected,
    );
}
...
fn mutation_with_client_extension() {
    ...
    test_fixture(
        ...
        "generate_flow/fixtures/mutation-with-client-extension.expected",
        input,
        expected,
    );
}
...
fn mutation_with_response_on_inline_fragments() {
    let input =
        include_str!("generate_flow/fixtures/mutation-with-response-on-inline-fragments.graphql");
    let expected =
        include_str!("generate_flow/fixtures/mutation-with-response-on-inline-fragments.expected");
    test_fixture(
        transform_fixture,
        "mutation-with-response-on-inline-fragments.graphql",
        "generate_flow/fixtures/mutation-with-response-on-inline-fragments.expected",
        input,
        expected,
    );
}
...
fn no_inline_fragment() {
    ...
    test_fixture(
        ...
        "generate_flow/fixtures/no-inline-fragment.expected",
        input,
        expected,
    );
}
...
fn query_mixed_provided_variables() {
    ...
    test_fixture(
        transform_fixture,
        "query-mixed-provided-variables.graphql",
        "generate_flow/fixtures/query-mixed-provided-variables.expected",
        input,
        expected,
    );
}
...
fn query_only_provided_variables() {
    ...
    test_fixture(
        transform_fixture,
        "query-only-provided-variables.graphql",
        "generate_flow/fixtures/query-only-provided-variables.expected",
        input,
        expected,
    );
}
...
fn query_provided_variables_custom_scalar() {
    let input =
        include_str!("generate_flow/fixtures/query-provided-variables-custom-scalar.graphql");
    let expected =
        include_str!("generate_flow/fixtures/query-provided-variables-custom-scalar.expected");
    test_fixture(
        transform_fixture,
        "query-provided-variables-custom-scalar.graphql",
        "generate_flow/fixtures/query-provided-variables-custom-scalar.expected",
        input,
        expected,
    );
}
...
fn regular_query_with_assignable_fragment_spread() {
    let input = include_str!(
        "generate_flow/fixtures/regular-query-with-assignable-fragment-spread.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/regular-query-with-assignable-fragment-spread.expected"
    );
    test_fixture(
        transform_fixture,
        "regular-query-with-assignable-fragment-spread.graphql",
        "generate_flow/fixtures/regular-query-with-assignable-fragment-spread.expected",
        input,
        expected,
    );
...
fn relay_live_resolver() {
    ...
    test_fixture(
        ...
        "generate_flow/fixtures/relay-live-resolver.expected",
        input,
        expected,
    );
}
...
fn relay_live_resolver_no_fragment() {
    ...
    test_fixture(
        transform_fixture,
        "relay-live-resolver-no-fragment.graphql",
        "generate_flow/fixtures/relay-live-resolver-no-fragment.expected",
        input,
        expected,
    );
}
...
fn relay_live_resolver_with_field_args() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/relay-live-resolver-with-field-args.expected");
    test_fixture(
        transform_fixture,
        "relay-live-resolver-with-field-args.graphql",
        "generate_flow/fixtures/relay-live-resolver-with-field-args.expected",
        input,
        expected,
    );
}
...
fn relay_live_resolver_with_field_args_no_fragment() {
    let input = include_str!(
        "generate_flow/fixtures/relay-live-resolver-with-field-args-no-fragment.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-live-resolver-with-field-args-no-fragment.expected"
    );
    test_fixture(
        transform_fixture,
        "relay-live-resolver-with-field-args-no-fragment.graphql",
        "generate_flow/fixtures/relay-live-resolver-with-field-args-no-fragment.expected",
        input,
        expected,
    );
...
fn relay_resolver() {
    ...
    test_fixture(
        ...
        "generate_flow/fixtures/relay-resolver.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_client_edge() {
    ...
    test_fixture(
        transform_fixture,
        "relay-resolver-client-edge.graphql",
        "generate_flow/fixtures/relay-resolver-client-edge.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_client_edge_required() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/relay-resolver-client-edge-required.expected");
    test_fixture(
        transform_fixture,
        "relay-resolver-client-edge-required.graphql",
        "generate_flow/fixtures/relay-resolver-client-edge-required.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_client_edge_required_edge() {
    let input =
        include_str!("generate_flow/fixtures/relay-resolver-client-edge-required-edge.graphql");
    let expected =
        include_str!("generate_flow/fixtures/relay-resolver-client-edge-required-edge.expected");
    test_fixture(
        transform_fixture,
        "relay-resolver-client-edge-required-edge.graphql",
        "generate_flow/fixtures/relay-resolver-client-edge-required-edge.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_in_fragment() {
    ...
    test_fixture(
        transform_fixture,
        "relay-resolver-in-fragment.graphql",
        "generate_flow/fixtures/relay-resolver-in-fragment.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_inject_fragment_data() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/relay-resolver-inject-fragment-data.expected");
    test_fixture(
        transform_fixture,
        "relay-resolver-inject-fragment-data.graphql",
        "generate_flow/fixtures/relay-resolver-inject-fragment-data.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_live_client_edge() {
    ...
    test_fixture(
        transform_fixture,
        "relay-resolver-live-client-edge.graphql",
        "generate_flow/fixtures/relay-resolver-live-client-edge.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_multiple_consumers() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/relay-resolver-multiple-consumers.expected");
    test_fixture(
        transform_fixture,
        "relay-resolver-multiple-consumers.graphql",
        "generate_flow/fixtures/relay-resolver-multiple-consumers.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_named_import() {
    ...
    test_fixture(
        ...
        "generate_flow/fixtures/relay-resolver-named-import.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_plural_client_edge() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/relay-resolver-plural-client-edge.expected");
    test_fixture(
        transform_fixture,
        "relay-resolver-plural-client-edge.graphql",
        "generate_flow/fixtures/relay-resolver-plural-client-edge.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_plural_client_edge_with_required_edge() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-plural-client-edge-with-required-edge.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-plural-client-edge-with-required-edge.expected"
    );
    test_fixture(
        transform_fixture,
        "relay-resolver-plural-client-edge-with-required-edge.graphql",
        "generate_flow/fixtures/relay-resolver-plural-client-edge-with-required-edge.expected",
        input,
        expected,
    );
...
fn relay_resolver_plural_required_client_edge() {
    let input =
        include_str!("generate_flow/fixtures/relay-resolver-plural-required-client-edge.graphql");
    let expected =
        include_str!("generate_flow/fixtures/relay-resolver-plural-required-client-edge.expected");
    test_fixture(
        transform_fixture,
        "relay-resolver-plural-required-client-edge.graphql",
        "generate_flow/fixtures/relay-resolver-plural-required-client-edge.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_raw_response() {
    ...
    test_fixture(
        transform_fixture,
        "relay-resolver-raw-response.graphql",
        "generate_flow/fixtures/relay-resolver-raw-response.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_required() {
    ...
    test_fixture(
        ...
        "generate_flow/fixtures/relay-resolver-required.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_scalar_plural() {
    ...
    test_fixture(
        transform_fixture,
        "relay-resolver-scalar-plural.graphql",
        "generate_flow/fixtures/relay-resolver-scalar-plural.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_with_output_type_client_interface() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-client-interface.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-client-interface.expected"
    );
    test_fixture(
        transform_fixture,
        "relay-resolver-with-output-type-client-interface.graphql",
        "generate_flow/fixtures/relay-resolver-with-output-type-client-interface.expected",
        input,
        expected,
    );
...
fn relay_resolver_with_output_type_client_object() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-client-object.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-client-object.expected"
    );
    test_fixture(
        transform_fixture,
...
fn relay_resolver_with_output_type_client_object_plural() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-client-object-plural.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-client-object-plural.expected"
    );
    test_fixture(
        transform_fixture,
        "relay-resolver-with-output-type-client-object-plural.graphql",
        "generate_flow/fixtures/relay-resolver-with-output-type-client-object-plural.expected",
        input,
        expected,
    );
...
fn relay_resolver_with_output_type_enum() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/relay-resolver-with-output-type-enum.expected");
    test_fixture(
        transform_fixture,
        "relay-resolver-with-output-type-enum.graphql",
        "generate_flow/fixtures/relay-resolver-with-output-type-enum.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_with_output_type_enum_plural() {
    let input =
        include_str!("generate_flow/fixtures/relay-resolver-with-output-type-enum-plural.graphql");
    let expected =
        include_str!("generate_flow/fixtures/relay-resolver-with-output-type-enum-plural.expected");
    test_fixture(
        transform_fixture,
        "relay-resolver-with-output-type-enum-plural.graphql",
        "generate_flow/fixtures/relay-resolver-with-output-type-enum-plural.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_with_output_type_relay_resolver_value() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-relay-resolver-value.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-relay-resolver-value.expected"
    );
    test_fixture(
        transform_fixture,
        "relay-resolver-with-output-type-relay-resolver-value.graphql",
        "generate_flow/fixtures/relay-resolver-with-output-type-relay-resolver-value.expected",
        input,
        expected,
    );
...
fn relay_resolver_with_output_type_scalar() {
    let input =
        include_str!("generate_flow/fixtures/relay-resolver-with-output-type-scalar.graphql");
    let expected =
        include_str!("generate_flow/fixtures/relay-resolver-with-output-type-scalar.expected");
    test_fixture(
        transform_fixture,
        "relay-resolver-with-output-type-scalar.graphql",
        "generate_flow/fixtures/relay-resolver-with-output-type-scalar.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_with_output_type_scalar_plural() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-scalar-plural.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-scalar-plural.expected"
    );
    test_fixture(
        transform_fixture,
        "relay-resolver-with-output-type-scalar-plural.graphql",
        "generate_flow/fixtures/relay-resolver-with-output-type-scalar-plural.expected",
        input,
        expected,
    );
...
fn relay_resolver_with_output_type_scalar_required() {
    let input = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-scalar-required.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/relay-resolver-with-output-type-scalar-required.expected"
    );
    test_fixture(
        transform_fixture,
        "relay-resolver-with-output-type-scalar-required.graphql",
        "generate_flow/fixtures/relay-resolver-with-output-type-scalar-required.expected",
        input,
        expected,
    );
...
fn relay_weak_client_type() {
    ...
    test_fixture(
        transform_fixture,
        "relay-weak-client-type.graphql",
        "generate_flow/fixtures/relay-weak-client-type.expected",
        input,
        expected,
    );
}
...
fn required() {
    ...
    test_fixture(
        transform_fixture,
        "required.graphql",
        "generate_flow/fixtures/required.expected",
        input,
        expected,
    );
}
...
fn required_bubbles_through_inline_fragments_to_fragment() {
    let input = include_str!(
        "generate_flow/fixtures/required-bubbles-through-inline-fragments-to-fragment.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/required-bubbles-through-inline-fragments-to-fragment.expected"
    );
    test_fixture(
        transform_fixture,
...
fn required_bubbles_to_fragment() {
    ...
    test_fixture(
        transform_fixture,
        "required-bubbles-to-fragment.graphql",
        "generate_flow/fixtures/required-bubbles-to-fragment.expected",
        input,
        expected,
    );
}
...
fn required_bubbles_to_item_in_plural_field() {
    let input =
        include_str!("generate_flow/fixtures/required-bubbles-to-item-in-plural-field.graphql");
    let expected =
        include_str!("generate_flow/fixtures/required-bubbles-to-item-in-plural-field.expected");
    test_fixture(
        transform_fixture,
        "required-bubbles-to-item-in-plural-field.graphql",
        "generate_flow/fixtures/required-bubbles-to-item-in-plural-field.expected",
        input,
        expected,
    );
}
...
fn required_bubbles_to_item_in_required_plural_field() {
    let input = include_str!(
        "generate_flow/fixtures/required-bubbles-to-item-in-required-plural-field.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/required-bubbles-to-item-in-required-plural-field.expected"
    );
    test_fixture(
        transform_fixture,
        "required-bubbles-to-item-in-required-plural-field.graphql",
        "generate_flow/fixtures/required-bubbles-to-item-in-required-plural-field.expected",
        input,
        expected,
    );
...
fn required_bubbles_to_non_null_linked_field() {
    let input =
        include_str!("generate_flow/fixtures/required-bubbles-to-non-null-linked-field.graphql");
    let expected =
        include_str!("generate_flow/fixtures/required-bubbles-to-non-null-linked-field.expected");
    test_fixture(
        transform_fixture,
        "required-bubbles-to-non-null-linked-field.graphql",
        "generate_flow/fixtures/required-bubbles-to-non-null-linked-field.expected",
        input,
        expected,
    );
}
...
fn required_bubbles_to_non_null_plural_linked_field() {
    let input = include_str!(
        "generate_flow/fixtures/required-bubbles-to-non-null-plural-linked-field.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/required-bubbles-to-non-null-plural-linked-field.expected"
    );
    test_fixture(
        transform_fixture,
        "required-bubbles-to-non-null-plural-linked-field.graphql",
        "generate_flow/fixtures/required-bubbles-to-non-null-plural-linked-field.expected",
        input,
        expected,
    );
...
fn required_bubbles_to_plural_fragment_root() {
    let input =
        include_str!("generate_flow/fixtures/required-bubbles-to-plural-fragment-root.graphql");
    let expected =
        include_str!("generate_flow/fixtures/required-bubbles-to-plural-fragment-root.expected");
    test_fixture(
        transform_fixture,
        "required-bubbles-to-plural-fragment-root.graphql",
        "generate_flow/fixtures/required-bubbles-to-plural-fragment-root.expected",
        input,
        expected,
    );
}
...
fn required_bubbles_to_query() {
    ...
    test_fixture(
        transform_fixture,
        "required-bubbles-to-query.graphql",
        "generate_flow/fixtures/required-bubbles-to-query.expected",
        input,
        expected,
    );
}
...
fn required_bubbles_up_to_mutation_response() {
    let input =
        include_str!("generate_flow/fixtures/required-bubbles-up-to-mutation-response.graphql");
    let expected =
        include_str!("generate_flow/fixtures/required-bubbles-up-to-mutation-response.expected");
    test_fixture(
        transform_fixture,
        "required-bubbles-up-to-mutation-response.graphql",
        "generate_flow/fixtures/required-bubbles-up-to-mutation-response.expected",
        input,
        expected,
    );
}
...
fn required_isolates_concrete_inline_fragments() {
    let input =
        include_str!("generate_flow/fixtures/required-isolates-concrete-inline-fragments.graphql");
    let expected =
        include_str!("generate_flow/fixtures/required-isolates-concrete-inline-fragments.expected");
    test_fixture(
        transform_fixture,
        "required-isolates-concrete-inline-fragments.graphql",
        "generate_flow/fixtures/required-isolates-concrete-inline-fragments.expected",
        input,
        expected,
    );
}
...
fn required_raw_response_type() {
    ...
    test_fixture(
        transform_fixture,
        "required-raw-response-type.graphql",
        "generate_flow/fixtures/required-raw-response-type.expected",
        input,
        expected,
    );
}
...
fn required_throw_doesnt_bubbles_to_fragment() {
    let input =
        include_str!("generate_flow/fixtures/required-throw-doesnt-bubbles-to-fragment.graphql");
    let expected =
        include_str!("generate_flow/fixtures/required-throw-doesnt-bubbles-to-fragment.expected");
    test_fixture(
        transform_fixture,
        "required-throw-doesnt-bubbles-to-fragment.graphql",
        "generate_flow/fixtures/required-throw-doesnt-bubbles-to-fragment.expected",
        input,
        expected,
    );
}
...
fn required_throw_doesnt_bubbles_to_query() {
    let input =
        include_str!("generate_flow/fixtures/required-throw-doesnt-bubbles-to-query.graphql");
    let expected =
        include_str!("generate_flow/fixtures/required-throw-doesnt-bubbles-to-query.expected");
    test_fixture(
        transform_fixture,
        "required-throw-doesnt-bubbles-to-query.graphql",
        "generate_flow/fixtures/required-throw-doesnt-bubbles-to-query.expected",
        input,
        expected,
    );
}
...
fn required_throws_nested() {
    ...
    test_fixture(
        transform_fixture,
        "required-throws-nested.graphql",
        "generate_flow/fixtures/required-throws-nested.expected",
        input,
        expected,
    );
}
...
fn required_throws_within_non_null_linked_field() {
    let input =
        include_str!("generate_flow/fixtures/required-throws-within-non-null-linked-field.graphql");
    let expected = include_str!(
        "generate_flow/fixtures/required-throws-within-non-null-linked-field.expected"
    );
    test_fixture(
        transform_fixture,
        "required-throws-within-non-null-linked-field.graphql",
        "generate_flow/fixtures/required-throws-within-non-null-linked-field.expected",
        input,
        expected,
    );
...
fn required_throws_within_non_null_plural_linked_field() {
    let input = include_str!(
        "generate_flow/fixtures/required-throws-within-non-null-plural-linked-field.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/required-throws-within-non-null-plural-linked-field.expected"
    );
    test_fixture(
        transform_fixture,
        "required-throws-within-non-null-plural-linked-field.graphql",
        "generate_flow/fixtures/required-throws-within-non-null-plural-linked-field.expected",
        input,
        expected,
    );
...
fn required_within_aliased_inline_fragment() {
    let input =
        include_str!("generate_flow/fixtures/required-within-aliased-inline-fragment.graphql");
    let expected =
        include_str!("generate_flow/fixtures/required-within-aliased-inline-fragment.expected");
    test_fixture(
        transform_fixture,
        "required-within-aliased-inline-fragment.graphql",
        "generate_flow/fixtures/required-within-aliased-inline-fragment.expected",
        input,
        expected,
    );
}
...
fn required_within_aliased_inline_fragment_on_abstract() {
    let input = include_str!(
        "generate_flow/fixtures/required-within-aliased-inline-fragment-on-abstract.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/required-within-aliased-inline-fragment-on-abstract.expected"
    );
    test_fixture(
        transform_fixture,
        "required-within-aliased-inline-fragment-on-abstract.graphql",
        "generate_flow/fixtures/required-within-aliased-inline-fragment-on-abstract.expected",
        input,
        expected,
    );
...
fn typename_in_union_with_other_fields() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/typename-in-union-with-other-fields.expected");
    test_fixture(
        transform_fixture,
        "typename-in-union-with-other-fields.graphql",
        "generate_flow/fixtures/typename-in-union-with-other-fields.expected",
        input,
        expected,
    );
}
...
fn typename_on_union_with_non_matching_aliases() {
    let input =
        include_str!("generate_flow/fixtures/typename-on-union-with-non-matching-aliases.graphql");
    let expected =
        include_str!("generate_flow/fixtures/typename-on-union-with-non-matching-aliases.expected");
    test_fixture(
        transform_fixture,
        "typename-on-union-with-non-matching-aliases.graphql",
        "generate_flow/fixtures/typename-on-union-with-non-matching-aliases.expected",
        input,
        expected,
    );
}
...
fn updatable_fragment_spread() {
    ...
    test_fixture(
        ...
        "generate_flow/fixtures/updatable-fragment-spread.expected",
        input,
        expected,
    );
}
...
fn updatable_fragment_spread_and_regular_spread() {
    let input =
        include_str!("generate_flow/fixtures/updatable-fragment-spread-and-regular-spread.graphql");
    let expected = include_str!(
        "generate_flow/fixtures/updatable-fragment-spread-and-regular-spread.expected"
    );
    test_fixture(
        transform_fixture,
        "updatable-fragment-spread-and-regular-spread.graphql",
        "generate_flow/fixtures/updatable-fragment-spread-and-regular-spread.expected",
        input,
        expected,
    );
...
fn updatable_fragment_spread_multiple() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/updatable-fragment-spread-multiple.expected");
    test_fixture(
        transform_fixture,
        "updatable-fragment-spread-multiple.graphql",
        "generate_flow/fixtures/updatable-fragment-spread-multiple.expected",
        input,
        expected,
    );
}
...
fn updatable_operation() {
    ...
    test_fixture(
        transform_fixture,
        "updatable-operation.graphql",
        "generate_flow/fixtures/updatable-operation.expected",
        input,
        expected,
    );
}
...
fn updatable_operation_assignable_fragment() {
    let input =
        include_str!("generate_flow/fixtures/updatable-operation-assignable-fragment.graphql");
    let expected =
        include_str!("generate_flow/fixtures/updatable-operation-assignable-fragment.expected");
    test_fixture(
        transform_fixture,
        "updatable-operation-assignable-fragment.graphql",
        "generate_flow/fixtures/updatable-operation-assignable-fragment.expected",
        input,
        expected,
    );
}
...
fn updatable_operation_assignable_fragment_plural() {
    let input = include_str!(
        "generate_flow/fixtures/updatable-operation-assignable-fragment-plural.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/updatable-operation-assignable-fragment-plural.expected"
    );
    test_fixture(
        transform_fixture,
        "updatable-operation-assignable-fragment-plural.graphql",
        "generate_flow/fixtures/updatable-operation-assignable-fragment-plural.expected",
        input,
        expected,
    );
...
fn updatable_operation_assignable_fragments_within_narrowing() {
    let input = include_str!(
        "generate_flow/fixtures/updatable-operation-assignable-fragments-within-narrowing.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/updatable-operation-assignable-fragments-within-narrowing.expected"
    );
    test_fixture(
        transform_fixture,
        "updatable-operation-assignable-fragments-within-narrowing.graphql",
        "generate_flow/fixtures/updatable-operation-assignable-fragments-within-narrowing.expected",
        input,
        expected,
    );
...
fn updatable_operation_multiple_assignable_fragments() {
    let input = include_str!(
        "generate_flow/fixtures/updatable-operation-multiple-assignable-fragments.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/updatable-operation-multiple-assignable-fragments.expected"
    );
    test_fixture(
        transform_fixture,
        "updatable-operation-multiple-assignable-fragments.graphql",
        "generate_flow/fixtures/updatable-operation-multiple-assignable-fragments.expected",
        input,
        expected,
    );
...
fn updatable_operation_plural_field_no_spreads() {
    let input =
        include_str!("generate_flow/fixtures/updatable-operation-plural-field-no-spreads.graphql");
    let expected =
        include_str!("generate_flow/fixtures/updatable-operation-plural-field-no-spreads.expected");
    test_fixture(
        transform_fixture,
        "updatable-operation-plural-field-no-spreads.graphql",
        "generate_flow/fixtures/updatable-operation-plural-field-no-spreads.expected",
        input,
        expected,
    );
}
...
fn updatable_operation_plural_field_with_spreads() {
    let input = include_str!(
        "generate_flow/fixtures/updatable-operation-plural-field-with-spreads.graphql"
    );
    let expected = include_str!(
        "generate_flow/fixtures/updatable-operation-plural-field-with-spreads.expected"
    );
    test_fixture(
        transform_fixture,
        "updatable-operation-plural-field-with-spreads.graphql",
        "generate_flow/fixtures/updatable-operation-plural-field-with-spreads.expected",
        input,
        expected,
    );
...
fn updatable_operation_special_fields() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/updatable-operation-special-fields.expected");
    test_fixture(
        transform_fixture,
        "updatable-operation-special-fields.graphql",
        "generate_flow/fixtures/updatable-operation-special-fields.expected",
        input,
        expected,
    );
}
...
fn updatable_operation_type_refinement() {
    ...
    let expected =
        include_str!("generate_flow/fixtures/updatable-operation-type-refinement.expected");
    test_fixture(
        transform_fixture,
        "updatable-operation-type-refinement.graphql",
        "generate_flow/fixtures/updatable-operation-type-refinement.expected",
        input,
        expected,
    );
}
