...
fn aliased_fragment_raw_response_type() {
    let input =
        include_str!("generate_typescript/fixtures/aliased-fragment-raw-response-type.graphql");
    let expected =
        include_str!("generate_typescript/fixtures/aliased-fragment-raw-response-type.expected");
    test_fixture(
        transform_fixture,
        "aliased-fragment-raw-response-type.graphql",
        "generate_typescript/fixtures/aliased-fragment-raw-response-type.expected",
        input,
        expected,
    );
}
...
fn aliased_fragment_spread() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/aliased-fragment-spread.expected",
        input,
        expected,
    );
}
...
fn aliased_fragment_spread_in_abstract_selection() {
    let input = include_str!(
        "generate_typescript/fixtures/aliased-fragment-spread-in-abstract-selection.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/aliased-fragment-spread-in-abstract-selection.expected"
    );
    test_fixture(
        transform_fixture,
...
fn aliased_inline_fragment_spread() {
    ...
    let expected =
        include_str!("generate_typescript/fixtures/aliased-inline-fragment-spread.expected");
    test_fixture(
        transform_fixture,
        "aliased-inline-fragment-spread.graphql",
        "generate_typescript/fixtures/aliased-inline-fragment-spread.expected",
        input,
        expected,
    );
}
...
fn conditional() {
    ...
    test_fixture(
        transform_fixture,
        "conditional.graphql",
        "generate_typescript/fixtures/conditional.expected",
        input,
        expected,
    );
}
...
fn custom_scalar_type_import() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/custom-scalar-type-import.expected",
        input,
        expected,
    );
}
...
fn fragment_spread() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/fragment-spread.expected",
        input,
        expected,
    );
}
...
fn inline_fragment() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/inline-fragment.expected",
        input,
        expected,
    );
}
...
fn linked_field() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/linked-field.expected",
        input,
        expected,
    );
}
...
fn match_field() {
    ...
    test_fixture(
        transform_fixture,
        "match-field.graphql",
        "generate_typescript/fixtures/match-field.expected",
        input,
        expected,
    );
}
...
fn mutation() {
    ...
    test_fixture(
        transform_fixture,
        "mutation.graphql",
        "generate_typescript/fixtures/mutation.expected",
        input,
        expected,
    );
}
...
fn mutation_input_has_array() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/mutation-input-has-array.expected",
        input,
        expected,
    );
}
...
fn mutation_with_enums_on_fragment() {
    ...
    let expected =
        include_str!("generate_typescript/fixtures/mutation-with-enums-on-fragment.expected");
    test_fixture(
        transform_fixture,
        "mutation-with-enums-on-fragment.graphql",
        "generate_typescript/fixtures/mutation-with-enums-on-fragment.expected",
        input,
        expected,
    );
}
...
fn mutation_with_nested_fragments() {
    ...
    let expected =
        include_str!("generate_typescript/fixtures/mutation-with-nested-fragments.expected");
    test_fixture(
        transform_fixture,
        "mutation-with-nested-fragments.graphql",
        "generate_typescript/fixtures/mutation-with-nested-fragments.expected",
        input,
        expected,
    );
}
...
fn plural_fragment() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/plural-fragment.expected",
        input,
        expected,
    );
}
...
fn query_with_handles() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/query-with-handles.expected",
        input,
        expected,
    );
}
...
fn query_with_match_fields() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/query-with-match-fields.expected",
        input,
        expected,
    );
}
...
fn query_with_module_field() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/query-with-module-field.expected",
        input,
        expected,
    );
}
...
fn query_with_multiple_match_fields() {
    let input =
        include_str!("generate_typescript/fixtures/query-with-multiple-match-fields.graphql");
    let expected =
        include_str!("generate_typescript/fixtures/query-with-multiple-match-fields.expected");
    test_fixture(
        transform_fixture,
        "query-with-multiple-match-fields.graphql",
        "generate_typescript/fixtures/query-with-multiple-match-fields.expected",
        input,
        expected,
    );
}
...
fn query_with_raw_response_on_conditional() {
    let input =
        include_str!("generate_typescript/fixtures/query-with-raw-response-on-conditional.graphql");
    let expected = include_str!(
        "generate_typescript/fixtures/query-with-raw-response-on-conditional.expected"
    );
    test_fixture(
        transform_fixture,
...
fn query_with_raw_response_on_literal_conditional() {
    let input = include_str!(
        "generate_typescript/fixtures/query-with-raw-response-on-literal-conditional.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/query-with-raw-response-on-literal-conditional.expected"
    );
    test_fixture(
        transform_fixture,
...
fn query_with_stream() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/query-with-stream.expected",
        input,
        expected,
    );
}
...
fn query_with_stream_connection() {
    ...
    let expected =
        include_str!("generate_typescript/fixtures/query-with-stream-connection.expected");
    test_fixture(
        transform_fixture,
        "query-with-stream-connection.graphql",
        "generate_typescript/fixtures/query-with-stream-connection.expected",
        input,
        expected,
    );
}
...
fn recursive_fragments() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/recursive-fragments.expected",
        input,
        expected,
    );
}
...
fn refetchable() {
    ...
    test_fixture(
        transform_fixture,
        "refetchable.graphql",
        "generate_typescript/fixtures/refetchable.expected",
        input,
        expected,
    );
}
...
fn refetchable_fragment() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/refetchable-fragment.expected",
        input,
        expected,
    );
}
...
fn relay_client_id_field() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/relay-client-id-field.expected",
        input,
        expected,
    );
}
...
fn relay_resolver_with_output_type_client_interface() {
    let input = include_str!(
        "generate_typescript/fixtures/relay-resolver-with-output-type-client-interface.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/relay-resolver-with-output-type-client-interface.expected"
    );
    test_fixture(
        transform_fixture,
...
fn relay_resolver_with_output_type_client_object() {
    let input = include_str!(
        "generate_typescript/fixtures/relay-resolver-with-output-type-client-object.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/relay-resolver-with-output-type-client-object.expected"
    );
    test_fixture(
        transform_fixture,
...
fn relay_weak_client_type() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/relay-weak-client-type.expected",
        input,
        expected,
    );
}
...
fn required() {
    ...
    test_fixture(
        transform_fixture,
        "required.graphql",
        "generate_typescript/fixtures/required.expected",
        input,
        expected,
    );
}
...
fn required_bubbles_to_fragment() {
    ...
    let expected =
        include_str!("generate_typescript/fixtures/required-bubbles-to-fragment.expected");
    test_fixture(
        transform_fixture,
        "required-bubbles-to-fragment.graphql",
        "generate_typescript/fixtures/required-bubbles-to-fragment.expected",
        input,
        expected,
    );
}
...
fn required_bubbles_to_item_in_plural_field() {
    let input = include_str!(
        "generate_typescript/fixtures/required-bubbles-to-item-in-plural-field.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/required-bubbles-to-item-in-plural-field.expected"
    );
    test_fixture(
        transform_fixture,
...
fn required_bubbles_to_query() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/required-bubbles-to-query.expected",
        input,
        expected,
    );
}
...
fn required_bubbles_up_to_mutation_response() {
    let input = include_str!(
        "generate_typescript/fixtures/required-bubbles-up-to-mutation-response.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/required-bubbles-up-to-mutation-response.expected"
    );
    test_fixture(
        transform_fixture,
...
fn required_isolates_concrete_inline_fragments() {
    let input = include_str!(
        "generate_typescript/fixtures/required-isolates-concrete-inline-fragments.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/required-isolates-concrete-inline-fragments.expected"
    );
    test_fixture(
        transform_fixture,
...
fn required_raw_response_type() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/required-raw-response-type.expected",
        input,
        expected,
    );
}
...
fn required_throw_doesnt_bubbles_to_fragment() {
    let input = include_str!(
        "generate_typescript/fixtures/required-throw-doesnt-bubbles-to-fragment.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/required-throw-doesnt-bubbles-to-fragment.expected"
    );
    test_fixture(
        transform_fixture,
...
fn required_throw_doesnt_bubbles_to_query() {
    let input =
        include_str!("generate_typescript/fixtures/required-throw-doesnt-bubbles-to-query.graphql");
    let expected = include_str!(
        "generate_typescript/fixtures/required-throw-doesnt-bubbles-to-query.expected"
    );
    test_fixture(
        transform_fixture,
...
fn required_throws_nested() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/required-throws-nested.expected",
        input,
        expected,
    );
}
...
fn required_within_aliased_inline_fragment() {
    let input = include_str!(
        "generate_typescript/fixtures/required-within-aliased-inline-fragment.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/required-within-aliased-inline-fragment.expected"
    );
    test_fixture(
        transform_fixture,
...
fn required_within_aliased_inline_fragment_on_abstract() {
    let input = include_str!(
        "generate_typescript/fixtures/required-within-aliased-inline-fragment-on-abstract.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/required-within-aliased-inline-fragment-on-abstract.expected"
    );
    test_fixture(
        transform_fixture,
...
fn roots() {
    ...
    test_fixture(
        transform_fixture,
        "roots.graphql",
        "generate_typescript/fixtures/roots.expected",
        input,
        expected,
    );
}
...
fn scalar_field() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/scalar-field.expected",
        input,
        expected,
    );
}
...
fn simple() {
    ...
    test_fixture(
        transform_fixture,
        "simple.graphql",
        "generate_typescript/fixtures/simple.expected",
        input,
        expected,
    );
}
...
fn simple_use_import_type_syntax() {
    ...
    let expected =
        include_str!("generate_typescript/fixtures/simple-use-import-type-syntax.expected");
    test_fixture(
        transform_fixture,
        "simple-use-import-type-syntax.graphql",
        "generate_typescript/fixtures/simple-use-import-type-syntax.expected",
        input,
        expected,
    );
}
...
fn typename_in_union_with_other_fields() {
    let input =
        include_str!("generate_typescript/fixtures/typename-in-union-with-other-fields.graphql");
    let expected =
        include_str!("generate_typescript/fixtures/typename-in-union-with-other-fields.expected");
    test_fixture(
        transform_fixture,
        "typename-in-union-with-other-fields.graphql",
        "generate_typescript/fixtures/typename-in-union-with-other-fields.expected",
        input,
        expected,
    );
}
...
fn typename_inside_with_overlapping_fields() {
    let input = include_str!(
        "generate_typescript/fixtures/typename-inside-with-overlapping-fields.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/typename-inside-with-overlapping-fields.expected"
    );
    test_fixture(
        transform_fixture,
...
fn typename_on_union() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/typename-on-union.expected",
        input,
        expected,
    );
}
...
fn typename_on_union_with_non_matching_aliases() {
    let input = include_str!(
        "generate_typescript/fixtures/typename-on-union-with-non-matching-aliases.graphql"
    );
    let expected = include_str!(
        "generate_typescript/fixtures/typename-on-union-with-non-matching-aliases.expected"
    );
    test_fixture(
        transform_fixture,
...
fn unmasked_fragment_spreads() {
    ...
    test_fixture(
        ...
        "generate_typescript/fixtures/unmasked-fragment-spreads.expected",
        input,
        expected,
    );
}
