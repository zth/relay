...
fn client_conditions() {
    ...
    test_fixture(
        ...
        "client_extensions/fixtures/client-conditions.expected",
        input,
        expected,
    );
}
...
fn client_fields_in_inline_fragments() {
    let input =
        include_str!("client_extensions/fixtures/client-fields-in-inline-fragments.graphql");
    let expected =
        include_str!("client_extensions/fixtures/client-fields-in-inline-fragments.expected");
    test_fixture(
        transform_fixture,
        "client-fields-in-inline-fragments.graphql",
        "client_extensions/fixtures/client-fields-in-inline-fragments.expected",
        input,
        expected,
    );
}
...
fn client_fields_on_roots() {
    ...
    test_fixture(
        ...
        "client_extensions/fixtures/client-fields-on-roots.expected",
        input,
        expected,
    );
}
...
fn sibling_client_selections() {
    ...
    test_fixture(
        ...
        "client_extensions/fixtures/sibling-client-selections.expected",
        input,
        expected,
    );
}
