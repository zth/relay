 ...
 *
 * @generated SignedSource<<44a8c537a98a80a74d430701a2fb3bd8>>
 */
...
fn connection() {
    ...
    test_fixture(
        transform_fixture,
        "connection.graphql",
        "connections/fixtures/connection.expected",
        input,
        expected,
    );
}
...
fn connection_directions() {
    ...
    test_fixture(
        transform_fixture,
        "connection-directions.graphql",
        "connections/fixtures/connection-directions.expected",
        input,
        expected,
    );
}
...
fn connection_empty_filters() {
    ...
    test_fixture(
        transform_fixture,
        "connection-empty-filters.graphql",
        "connections/fixtures/connection-empty-filters.expected",
        input,
        expected,
    );
}
...
fn connection_filters() {
    ...
    test_fixture(
        transform_fixture,
        "connection-filters.graphql",
        "connections/fixtures/connection-filters.expected",
        input,
        expected,
    );
}
...
fn connection_generate_filters() {
    ...
    test_fixture(
        transform_fixture,
        "connection-generate-filters.graphql",
        "connections/fixtures/connection-generate-filters.expected",
        input,
        expected,
    );
}
...
fn connection_with_aliased_edges_page_info() {
    let input =
        include_str!("connections/fixtures/connection-with-aliased-edges-page-info.graphql");
    let expected =
        include_str!("connections/fixtures/connection-with-aliased-edges-page-info.expected");
    test_fixture(
        transform_fixture,
        "connection-with-aliased-edges-page-info.graphql",
        "connections/fixtures/connection-with-aliased-edges-page-info.expected",
        input,
        expected,
    );
}
...
fn connection_with_custom_handler() {
    ...
    test_fixture(
        transform_fixture,
        "connection-with-custom-handler.graphql",
        "connections/fixtures/connection-with-custom-handler.expected",
        input,
        expected,
    );
}
...
fn connection_with_page_info() {
    ...
    test_fixture(
        transform_fixture,
        "connection-with-page-info.graphql",
        "connections/fixtures/connection-with-page-info.expected",
        input,
        expected,
    );
}
...
fn connection_with_variables() {
    ...
    test_fixture(
        transform_fixture,
        "connection-with-variables.graphql",
        "connections/fixtures/connection-with-variables.expected",
        input,
        expected,
    );
}
