...
fn argument_definitions_typo_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/argument_definitions_typo.invalid.expected",
        input,
        expected,
    );
}
...
fn complex_object_with_invalid_constant_fields_invalid() {
    let input =
        include_str!("parse/fixtures/complex-object-with-invalid-constant-fields.invalid.graphql");
    let expected =
        include_str!("parse/fixtures/complex-object-with-invalid-constant-fields.invalid.expected");
    test_fixture(
        transform_fixture,
        "complex-object-with-invalid-constant-fields.invalid.graphql",
        "parse/fixtures/complex-object-with-invalid-constant-fields.invalid.expected",
        input,
        expected,
    );
}
...
fn complex_object_with_invalid_fields_invalid() {
    ...
    test_fixture(
        transform_fixture,
        "complex-object-with-invalid-fields.invalid.graphql",
        "parse/fixtures/complex-object-with-invalid-fields.invalid.expected",
        input,
        expected,
    );
}
...
fn complex_object_with_missing_fields_invalid() {
    ...
    test_fixture(
        transform_fixture,
        "complex-object-with-missing-fields.invalid.graphql",
        "parse/fixtures/complex-object-with-missing-fields.invalid.expected",
        input,
        expected,
    );
}
...
fn directive_generic() {
    ...
    test_fixture(
        ...
        "parse/fixtures/directive-generic.expected",
        input,
        expected,
    );
}
...
fn directive_include() {
    ...
    test_fixture(
        ...
        "parse/fixtures/directive-include.expected",
        input,
        expected,
    );
}
...
fn directive_match_on_fragment_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/directive-match-on-fragment.invalid.expected",
        input,
        expected,
    );
}
...
fn directive_missing_required_argument_invalid() {
    ...
    test_fixture(
        transform_fixture,
        "directive_missing_required_argument.invalid.graphql",
        "parse/fixtures/directive_missing_required_argument.invalid.expected",
        input,
        expected,
    );
}
...
fn directive_module_match_on_query_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/directive-module-match-on-query.invalid.expected",
        input,
        expected,
    );
}
...
fn directive_module_on_field_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/directive-module-on-field.invalid.expected",
        input,
        expected,
    );
}
...
fn directive_unknown_argument_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/directive-unknown-argument.invalid.expected",
        input,
        expected,
    );
}
...
fn directive_wrong_argument_type_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/directive_wrong_argument_type.invalid.expected",
        input,
        expected,
    );
}
...
fn duplicate_arguments_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/duplicate_arguments.invalid.expected",
        input,
        expected,
    );
}
...
fn duplicate_variables_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/duplicate_variables_invalid.expected",
        input,
        expected,
    );
}
...
fn enum_values() {
    ...
    test_fixture(
        transform_fixture,
        "enum-values.graphql",
        "parse/fixtures/enum-values.expected",
        input,
        expected,
    );
}
...
fn enum_values_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/enum-values.invalid.expected",
        input,
        expected,
    );
}
...
fn fetch_token_with_arguments_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fetch_token_with_arguments.invalid.expected",
        input,
        expected,
    );
}
...
fn field_argument_missing_required_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/field_argument_missing_required.invalid.expected",
        input,
        expected,
    );
}
...
fn field_argument_unknown_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/field_argument_unknown.invalid.expected",
        input,
        expected,
    );
}
...
fn field_argument_wrong_type_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/field_argument_wrong_type.invalid.expected",
        input,
        expected,
    );
}
...
fn field_arguments() {
    ...
    test_fixture(
        ...
        "parse/fixtures/field-arguments.expected",
        input,
        expected,
    );
}
...
fn fixme_fat_interface_on_union() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fixme_fat_interface_on_union.expected",
        input,
        expected,
    );
}
...
fn fixme_fat_interface_on_union_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fixme_fat_interface_on_union.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_spread_on_wrong_type_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fragment-spread-on-wrong-type.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_spread_within_wrong_parent_type_invalid() {
    let input =
        include_str!("parse/fixtures/fragment-spread-within-wrong-parent-type.invalid.graphql");
    let expected =
        include_str!("parse/fixtures/fragment-spread-within-wrong-parent-type.invalid.expected");
    test_fixture(
        transform_fixture,
        "fragment-spread-within-wrong-parent-type.invalid.graphql",
        "parse/fixtures/fragment-spread-within-wrong-parent-type.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_with_argument_type_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fragment-with-argument-type.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_with_argument_type_syntax_error_invalid() {
    let input =
        include_str!("parse/fixtures/fragment-with-argument-type-syntax-error.invalid.graphql");
    let expected =
        include_str!("parse/fixtures/fragment-with-argument-type-syntax-error.invalid.expected");
    test_fixture(
        transform_fixture,
        "fragment-with-argument-type-syntax-error.invalid.graphql",
        "parse/fixtures/fragment-with-argument-type-syntax-error.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_with_arguments() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fragment-with-arguments.expected",
        input,
        expected,
    );
}
...
fn fragment_with_arguments_defaulting() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fragment_with_arguments_defaulting.expected",
        input,
        expected,
    );
}
...
fn fragment_with_arguments_duplicate_invalid() {
    ...
    test_fixture(
        transform_fixture,
        "fragment-with-arguments-duplicate.invalid.graphql",
        "parse/fixtures/fragment-with-arguments-duplicate.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_with_arguments_incorrect_nullability_invalid() {
    let input = include_str!(
        "parse/fixtures/fragment_with_arguments_incorrect_nullability.invalid.graphql"
    );
    let expected = include_str!(
        "parse/fixtures/fragment_with_arguments_incorrect_nullability.invalid.expected"
    );
    test_fixture(
        transform_fixture,
        "fragment_with_arguments_incorrect_nullability.invalid.graphql",
        "parse/fixtures/fragment_with_arguments_incorrect_nullability.invalid.expected",
        input,
        expected,
    );
...
fn fragment_with_arguments_invalid_type_invalid() {
    ...
    test_fixture(
        transform_fixture,
        "fragment-with-arguments-invalid-type.invalid.graphql",
        "parse/fixtures/fragment-with-arguments-invalid-type.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_with_arguments_syntax() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fragment-with-arguments-syntax.expected",
        input,
        expected,
    );
}
...
fn fragment_with_both_arguments_and_directive_invalid() {
    let input =
        include_str!("parse/fixtures/fragment-with-both-arguments-and-directive.invalid.graphql");
    let expected =
        include_str!("parse/fixtures/fragment-with-both-arguments-and-directive.invalid.expected");
    test_fixture(
        transform_fixture,
        "fragment-with-both-arguments-and-directive.invalid.graphql",
        "parse/fixtures/fragment-with-both-arguments-and-directive.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_with_both_variable_definition_and_directive_invalid() {
    let input = include_str!(
        "parse/fixtures/fragment-with-both-variable-definition-and-directive.invalid.graphql"
    );
    let expected = include_str!(
        "parse/fixtures/fragment-with-both-variable-definition-and-directive.invalid.expected"
    );
    test_fixture(
        transform_fixture,
        "fragment-with-both-variable-definition-and-directive.invalid.graphql",
        "parse/fixtures/fragment-with-both-variable-definition-and-directive.invalid.expected",
        input,
        expected,
    );
...
fn fragment_with_literal_arguments() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fragment-with-literal-arguments.expected",
        input,
        expected,
    );
}
...
fn fragment_with_literal_enum_arguments() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fragment-with-literal-enum-arguments.expected",
        input,
        expected,
    );
}
...
fn fragment_with_literal_enum_arguments_into_enum_list() {
    let input =
        include_str!("parse/fixtures/fragment-with-literal-enum-arguments-into-enum-list.graphql");
    let expected =
        include_str!("parse/fixtures/fragment-with-literal-enum-arguments-into-enum-list.expected");
    test_fixture(
        transform_fixture,
        "fragment-with-literal-enum-arguments-into-enum-list.graphql",
        "parse/fixtures/fragment-with-literal-enum-arguments-into-enum-list.expected",
        input,
        expected,
    );
}
...
fn fragment_with_literal_enum_list_arguments() {
    ...
    test_fixture(
        transform_fixture,
        "fragment-with-literal-enum-list-arguments.graphql",
        "parse/fixtures/fragment-with-literal-enum-list-arguments.expected",
        input,
        expected,
    );
}
...
fn fragment_with_literal_object_arguments() {
    ...
    test_fixture(
        ...
        "parse/fixtures/fragment-with-literal-object-arguments.expected",
        input,
        expected,
    );
}
...
fn fragment_with_literal_object_list_arguments() {
    ...
    test_fixture(
        transform_fixture,
        "fragment-with-literal-object-list-arguments.graphql",
        "parse/fixtures/fragment-with-literal-object-list-arguments.expected",
        input,
        expected,
    );
}
...
fn fragment_with_undefined_literal_arguments_invalid() {
    let input =
        include_str!("parse/fixtures/fragment-with-undefined-literal-arguments.invalid.graphql");
    let expected =
        include_str!("parse/fixtures/fragment-with-undefined-literal-arguments.invalid.expected");
    test_fixture(
        transform_fixture,
        "fragment-with-undefined-literal-arguments.invalid.graphql",
        "parse/fixtures/fragment-with-undefined-literal-arguments.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_with_undefined_variable_arguments_invalid() {
    let input =
        include_str!("parse/fixtures/fragment-with-undefined-variable-arguments.invalid.graphql");
    let expected =
        include_str!("parse/fixtures/fragment-with-undefined-variable-arguments.invalid.expected");
    test_fixture(
        transform_fixture,
        "fragment-with-undefined-variable-arguments.invalid.graphql",
        "parse/fixtures/fragment-with-undefined-variable-arguments.invalid.expected",
        input,
        expected,
    );
}
...
fn fragment_with_unnecessary_unchecked_arguments_invalid() {
    let input = include_str!(
        "parse/fixtures/fragment-with-unnecessary-unchecked-arguments.invalid.graphql"
    );
    let expected = include_str!(
        "parse/fixtures/fragment-with-unnecessary-unchecked-arguments.invalid.expected"
    );
    test_fixture(
        transform_fixture,
        "fragment-with-unnecessary-unchecked-arguments.invalid.graphql",
        "parse/fixtures/fragment-with-unnecessary-unchecked-arguments.invalid.expected",
        input,
        expected,
    );
...
fn fragment_with_variable_definitions_syntax() {
    ...
    test_fixture(
        transform_fixture,
        "fragment-with-variable-definitions-syntax.graphql",
        "parse/fixtures/fragment-with-variable-definitions-syntax.expected",
        input,
        expected,
    );
}
...
fn fragment_with_variable_definitions_syntax_and_argdefs_invalid() {
    let input = include_str!(
        "parse/fixtures/fragment-with-variable-definitions-syntax-and-argdefs.invalid.graphql"
    );
    let expected = include_str!(
        "parse/fixtures/fragment-with-variable-definitions-syntax-and-argdefs.invalid.expected"
    );
    test_fixture(
        transform_fixture,
        "fragment-with-variable-definitions-syntax-and-argdefs.invalid.graphql",
        "parse/fixtures/fragment-with-variable-definitions-syntax-and-argdefs.invalid.expected",
        input,
        expected,
    );
...
fn inline_fragment_on_wrong_type_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/inline-fragment-on-wrong-type.invalid.expected",
        input,
        expected,
    );
}
...
fn inline_fragment_with_invalid_type() {
    ...
    test_fixture(
        ...
        "parse/fixtures/inline-fragment-with-invalid-type.expected",
        input,
        expected,
    );
}
...
fn inline_fragment_within_wrong_parent_type_invalid() {
    let input =
        include_str!("parse/fixtures/inline-fragment-within-wrong-parent-type.invalid.graphql");
    let expected =
        include_str!("parse/fixtures/inline-fragment-within-wrong-parent-type.invalid.expected");
    test_fixture(
        transform_fixture,
        "inline-fragment-within-wrong-parent-type.invalid.graphql",
        "parse/fixtures/inline-fragment-within-wrong-parent-type.invalid.expected",
        input,
        expected,
    );
}
...
fn inline_untyped_fragment() {
    ...
    test_fixture(
        ...
        "parse/fixtures/inline-untyped-fragment.expected",
        input,
        expected,
    );
}
...
fn invalid_argument_type_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/invalid-argument-type.invalid.expected",
        input,
        expected,
    );
}
...
fn linked_field_with_no_selection_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/linked-field-with-no-selection.invalid.expected",
        input,
        expected,
    );
}
...
fn linked_handle_field() {
    ...
    test_fixture(
        ...
        "parse/fixtures/linked-handle-field.expected",
        input,
        expected,
    );
}
...
fn linked_handle_field_with_filters() {
    ...
    test_fixture(
        ...
        "parse/fixtures/linked-handle-field-with-filters.expected",
        input,
        expected,
    );
}
...
fn linked_handle_field_with_key() {
    ...
    test_fixture(
        ...
        "parse/fixtures/linked-handle-field-with-key.expected",
        input,
        expected,
    );
}
...
fn linked_handle_filter() {
    ...
    test_fixture(
        ...
        "parse/fixtures/linked-handle-filter.expected",
        input,
        expected,
    );
}
...
fn list_argument() {
    ...
    test_fixture(
        ...
        "parse/fixtures/list-argument.expected",
        input,
        expected,
    );
}
...
fn list_argument_complex_object() {
    ...
    test_fixture(
        ...
        "parse/fixtures/list-argument-complex-object.expected",
        input,
        expected,
    );
}
...
fn list_of_enums() {
    ...
    test_fixture(
        ...
        "parse/fixtures/list-of-enums.expected",
        input,
        expected,
    );
}
...
fn literal_list_argument() {
    ...
    test_fixture(
        ...
        "parse/fixtures/literal-list-argument.expected",
        input,
        expected,
    );
}
...
fn literal_list_argument_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/literal-list-argument.invalid.expected",
        input,
        expected,
    );
}
...
fn literal_object_argument() {
    ...
    test_fixture(
        ...
        "parse/fixtures/literal-object-argument.expected",
        input,
        expected,
    );
}
...
fn literal_object_argument_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/literal-object-argument.invalid.expected",
        input,
        expected,
    );
}
...
fn null_values() {
    ...
    test_fixture(
        transform_fixture,
        "null-values.graphql",
        "parse/fixtures/null-values.expected",
        input,
        expected,
    );
}
...
fn null_values_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/null-values.invalid.expected",
        input,
        expected,
    );
}
...
fn object_argument() {
    ...
    test_fixture(
        ...
        "parse/fixtures/object-argument.expected",
        input,
        expected,
    );
}
...
fn query_with_argument_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/query-with-argument.invalid.expected",
        input,
        expected,
    );
}
...
fn scalar_field_with_selection() {
    ...
    test_fixture(
        ...
        "parse/fixtures/scalar-field-with-selection.expected",
        input,
        expected,
    );
}
...
fn scalar_handle_field() {
    ...
    test_fixture(
        ...
        "parse/fixtures/scalar-handle-field.expected",
        input,
        expected,
    );
}
...
fn simple_query() {
    ...
    test_fixture(
        ...
        "parse/fixtures/simple-query.expected",
        input,
        expected,
    );
}
...
fn subscription_with_multiple_selections_invalid() {
    let input =
        include_str!("parse/fixtures/subscription-with-multiple-selections.invalid.graphql");
    let expected =
        include_str!("parse/fixtures/subscription-with-multiple-selections.invalid.expected");
    test_fixture(
        transform_fixture,
        "subscription-with-multiple-selections.invalid.graphql",
        "parse/fixtures/subscription-with-multiple-selections.invalid.expected",
        input,
        expected,
    );
}
...
fn typename_with_arguments_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/typename_with_arguments.invalid.expected",
        input,
        expected,
    );
}
...
fn undefined_fragment_but_close_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/undefined-fragment-but-close.invalid.expected",
        input,
        expected,
    );
}
...
fn undefined_fragment_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/undefined-fragment.invalid.expected",
        input,
        expected,
    );
}
...
fn undefined_type_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/undefined-type.invalid.expected",
        input,
        expected,
    );
}
...
fn unknown_field_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/unknown_field.invalid.expected",
        input,
        expected,
    );
}
...
fn unknown_fragment_type_invalid() {
    ...
    test_fixture(
        ...
        "parse/fixtures/unknown-fragment-type.invalid.expected",
        input,
        expected,
    );
}
...
fn unknown_fragment_type_suggestions_invalid() {
    ...
    test_fixture(
        transform_fixture,
        "unknown-fragment-type-suggestions.invalid.graphql",
        "parse/fixtures/unknown-fragment-type-suggestions.invalid.expected",
        input,
        expected,
    );
}
