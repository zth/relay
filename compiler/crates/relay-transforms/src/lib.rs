...
mod melange_relay_generate_typename;
mod melange_relay_remove_custom_directives;
mod root_variables;
...
pub use melange_relay_generate_typename::melange_relay_generate_typename;
pub use melange_relay_remove_custom_directives::melange_relay_remove_custom_directives;
