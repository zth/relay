...
<Image src={require('./images/2021-12-08-introducing-the-new-relay-compiler-post-required.png')} title="A component with less null-checking boilerplate, due to the use of the `@required` directive"/>
